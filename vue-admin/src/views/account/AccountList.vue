    ...
    <el-card>
      ...
      <el-table :data="tableData" border size="medium" v-on:selection-change="selectionChange">
        ...
        <el-table-column
          ...
          width="80"
        ></el-table-column>
        <el-table-column header-align="center" align="center" prop="account" label="账号名称"></el-table-column>
      ...
      <el-dialog title="编辑角色" :visible.sync="addDialogVisible" width="50%" @close="dialogClosed">
        ...
        >
          ...
          <el-form-item label="密码" prop="password" v-bind:required="required">
            <el-input type="password" v-model="accountForm.password" placeholder="请输入登录账号密码"></el-input>
          </el-form-item>
          <el-form-item label="排序号">
            <el-input-number v-model="accountForm.sort" :min="1" :max="10000" placeholder="排序号"></el-input-number>
          </el-form-item>
