...
namespace VueAdmin.EntityFrameworkCore
{
     ...
     * It is not used on runtime. See VueAdminDbContext for the runtime DbContext.
     * It is a unified model that includes configuration for
     * all used modules and your application.
     */
    public class VueAdminMigrationsDbContext : AbpDbContext<VueAdminMigrationsDbContext>
    {
        public VueAdminMigrationsDbContext(DbContextOptions<VueAdminMigrationsDbContext> options) 
            : base(options)
        {
